...
static const unsigned int gappiv    = 10;        /* gap size  */
static const unsigned int gappih    = 10;        /* gap size  */
...
static const char *fonts[]          = { "JetBrainsMono:size=12:style=Bold", "fontawesome:size=12" };
...
static const Rule rules[] = {
	...
	{ "Chromium", "chromium", NULL,                1,            0,           0,          -1,             -1 },
	{ "discord",  "discord",  NULL,                2,            0,           0,          -1,             -1 },
	{ "St",       "st",       "st",           1 << 2,            0,           1,          0,              -1 },
    { "Steam",    "Steam",    NULL,           1 << 3,            0,           0,          -1,             -1 },
    { NULL,       NULL,      "Event Tester",  1 << 3,            0,           0,          -1,             -1 }
};
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_F3,             spawn,              SHCMD("keepassxc") },
